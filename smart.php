...
$mail->Username = 'sinmws246@ivyandmarj.com';                 // SMTP username
$mail->Password = 'iddqdidkfa00';                           // SMTP password
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                                    // TCP port to connect to

$mail->setFrom('inmws246@ivyandmarj.com', 'Ildar S. Zhiganshin');
$mail->addAddress('inmws246@ivyandmarj.com', 'Joe User');     // Add a recipient
